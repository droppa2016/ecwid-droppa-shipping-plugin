try {
    ...
    tryInjectRosettaScript('https://d2scn539ulxr09.cloudfront.net/rosetta/translations2022/new-frontend/files/new-frontend.en.-1350586590.js', 'https://d201eyh6wia12q.cloudfront.net/translations2022/new-frontend/files/new-frontend.en.-1350586590.translations');
    })();
    (function() {
    ...
    script.src = selectJsVersion('https://d2scn539ulxr09.cloudfront.net/venera/static/ecwid-storefront.5f5ad6e09926cbb74fa8292edf7d8bed.min.js');
    document.getElementsByTagName('head')[0].appendChild(script);
    }
    ...
    script.src = selectJsVersion('https://d2scn539ulxr09.cloudfront.net/venera/static/ecwid-checkout.e56fd0c2cd4b0e0a36403666deac1b94.min.js');
    document.getElementsByTagName('head')[0].appendChild(script);
    ...
    window.Ecwid = {
    storefrontVersion: "2022-25898-ga2333e443b9",
    ...
    OnPageSwitch: new ep,
    signature: "6ebaaf0d417c84bbc255bb6713855333-0",
    ...
    window.ec_legacyCssUrl = 'https://d1oxsl77a1kjht.cloudfront.net/css/new/cut?hc=1663062571&ownerid=58231007&useProximaNovaFont=true' + cssUrlAddition;
    var cssUrl = 'https://d1oxsl77a1kjht.cloudfront.net/css/new?hc=1663062571&ownerid=58231007&useProximaNovaFont=true' + cssUrlAddition;
    ...
    return [
    {
    namespace: 'free-shipping-icon',
    cssUrl: 'https://d35z3p2poghz10.cloudfront.net/apps/thirdparty/free-shipping-icon/files/1.0.3/app.css',
    jsUrl: 'https://d35z3p2poghz10.cloudfront.net/apps/thirdparty/free-shipping-icon/files/1.0.3/app.js',
    asyncJs: true
    },
    {
    namespace: 'how-you-found-us',
    cssUrl: null,
    jsUrl: 'https://djqizrxa6f10j.cloudfront.net/apps/thirdparty/how-you-found-us/files/1.2.0/script.js',
    asyncJs: true
    },
    {
    namespace: 'shipstation-cloudier',
    cssUrl: null,
    jsUrl: 'https://ecwid.accesspoint.tech/public/shipstation.js',
    asyncJs: true
    },
    {
    ...
    xInjectJs('https://d2scn539ulxr09.cloudfront.net/static/br/2022-25898-ga2333e443b9/lang/en.js');
    }
    xInjectJs('https://d3dq8sxcny4hg.cloudfront.net/states.js?version=2022-25898-ga2333e443b9&callback=window.ecwid_states_data.loaded');
    ...
    window.ecwid_script_base="https://d2scn539ulxr09.cloudfront.net/static/br/2022-25898-ga2333e443b9/";
    ...
    window.xnext_ownerId=58231007;
    window.Ecwid.publicToken = "public_6WtvEREEhBKgwSDNmAmDJBSChANEhL8g",
    window.Ecwid.demo=false;
    window.Ecwid.cssUrl="https://d1oxsl77a1kjht.cloudfront.net/css/new?hc=1663062571&ownerid=58231007&useProximaNovaFont=true";
    ...
    var ecDataJsBaseUrl = "https://app.ecwid.com/data.js?ownerid=58231007";
    ...
    var tokenMap = {"droppa-dev":"public_fdbzePhYy7A64ZSVLX4DBMzCkinhiu7X","ecwid-storefront":"public_tAk3CdK2LBg57AzWvSM6WpYKtZBaz3LC","shipstation-cloudier":"public_phWVE3ANP2agbi9yM6NvJmK7t77mkxkh"};
    ...
    window.Ecwid.getAppPublicConfig = function(namespace) {
        var publicData = {"droppa-dev":"secret_zCRjfHCCdvgcs6wHyhmDYtEMaiXpN8X8","ecwid-edit-orders":"{}","ecwid-degenerator-app":"{}","starter-site":"{}","ecwid-vuega-app":"{}","ecwid-startersite-app":"{}","free-shipping-icon":"{}","storefront-label-editor":"","how-you-found-us":"{\"enabled\":\"true\",\"required\":\"false\",\"title\":\"\",\"tip\":\"\",\"selectOption1\":\"From a friend\",\"selectOption2\":\"I\u0027m a repeat customer\",\"selectOption3\":\"Facebook, Twitter\"}","shipstation-cloudier":"{}","ecwid-storefront":"{}"};
